...
//result = tz_snprintf(/*result,*/ buf, 800, "%+0*.*u", 20, 10, i);
		...
		/*result = snprintf*/CFMT_STR(result, buf, 2000,
			...
			//"%0*.*u|", -20, 10, i,
			"%a", /*-99.9999*/ /*sqrt(2.)*//*0./0*/ /*30,*/ (double)2/*(double)*//*pdata[i]*//*2.365*//*nullptr*//*nullptr*//*&i*/
...
///*result = tz_snprintf*/CFMT_STR(result, buf, 2000, "%.f", /*(long double)*//*i*/2.345);
        ...
        //result = snprintf/*CFMT_STR*/(/*result,*/ buf, 2000, "%.100a", /*0. / 0*//*std::numeric_limits<long double>::max()*//*1e+200*/(double)i/*-2.365*//*(double)1 / 3*/);
       //ret = std::to_chars(buf, buf + 2000, /*std::numeric_limits<double>::max()*//*(double)1 / 3*/(double)i, std::chars_format::hex, -1);
